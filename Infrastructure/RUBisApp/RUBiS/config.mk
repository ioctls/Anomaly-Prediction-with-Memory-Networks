...
CLASSPATH = .:./kafka-clients-2.0.0.jar:./slf4j-api-1.7.25.jar:$(J2EE_HOME)/lib/j2ee.jar:$(JAVA_HOME)/jre/lib/rt.jar:/cluster/opt/jakarta-tomcat-3.2.3/lib/servlet.jar:$(PWD)
