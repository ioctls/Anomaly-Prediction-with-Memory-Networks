...
public class UserSession extends Thread
{
  ...
  public int cnt =0;
  public long ttl =0;
  private final static String TOPIC = "responsetimeRubisApp";
  private final static String BOOTSTRAP_SERVERS ="152.46.18.175:9092";
  ...
  private Producer<String, String> createProducer() {
    ...
    private void runProducer(Producer<String, String> producer, final String key, final String msg) throws Exception {
		...
		{     // transition.resetToInitialState();
			...
			try{
				if ((System.currentTimeMillis()-current)>=1000 ){
					runProducer(producer, "0", String.valueOf(timeTaken)+","+String.valueOf(System.currentTimeMillis()/1000));
