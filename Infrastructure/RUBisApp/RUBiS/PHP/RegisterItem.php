...
<html>
  <body>
    ...
    $result = mysqli_query( $link,"INSERT INTO items VALUES (NULL, \"$name\",'no description', $initialPrice, $qty, $reservePrice, 0, 0, 0, '$start', '$end', $userId, $categoryId)") or die("ERROR: Failed to insert new item in database. MySQL reports '".mysqli_error()."' while querying 'INSERT INTO items VALUES (NULL, \"$name\", 'no description', $initialPrice, $qty, $reservePrice, 0,0,0, '$start', '$end', $userId, $categoryId)'");
    commit($link);
