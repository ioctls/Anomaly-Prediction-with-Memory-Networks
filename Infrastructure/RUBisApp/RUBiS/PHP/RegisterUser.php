...
<html>
  <body>
    ...
    $regionResult = mysqlQuery("SELECT * FROM regions WHERE name=\"$region\"", $link) or die("ERROR: Region query failed");
    ...
    $nicknameResult = mysqlQuery("SELECT * FROM users WHERE nickname=\"$nickname\"", $link) or die("ERROR: Nickname query failed");
    ...
    $result = mysqlQuery("INSERT INTO users VALUES (NULL, \"$firstname\", \"$lastname\", \"$nickname\", \"$password\", \"$email\", 0, 0, '$now', $regionId)", $link) or die("ERROR: Failed to insert new user in database.");

    $result = mysqlQuery("SELECT * FROM users WHERE nickname=\"$nickname\"", $link) or die("ERROR: Query user failed");
