...
<html>
  <body>
    ...
    $result = mysqlQuery("SELECT * FROM items WHERE items.id=$itemId") or die("ERROR: Item query failed");
    ...
    $toRes = mysqlQuery("SELECT * FROM users WHERE id=\"$to\"") or die("ERROR: User query failed");
