...
instance.lstmed = torch.load('../../models/vm16-137.vcl.ncsu.edu_used_memorylatest_latest_normal_ws_'+str(window_size)+'.pkl')
    ...
    try:
        ...
        while True:
            for msg in consumer:
                ...
                if((plugin == 'memory' and type_instance == 'used') == False):
                    continue;
